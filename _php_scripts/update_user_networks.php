<?php
	...
	$sql = "UPDATE neural_networks SET network_name='".$network_name."',network_json='".$network_json."',network_symbols='".$network_symbols."',network_user_id=".$network_user_id.",network_activation_function='".$network_activation_function."',network_hidden_layers='".$network_hidden_layers."' WHERE network_id = ".$network_id."  ;";
